...
<form action="<?php echo URLROOT ;?>skillendusers/launch" method="post" >
<div class="container-fluid">
    <div class="row pt-4 mb-1">
            <div class="col-sm-5 mt-1"><div class="line"></div></div>
            <div class="col-sm-2 text-center" ><b>My COURSE</b></div>
    </div>
 ...
 <div class="container-fluid p-2" style="width:95%;display:block;margin:auto;">
    <div class="row mb-0" style="border:2px solid #ffc104;border-radius:10px;">
        ...
        <div class="col-sm-4 mt-4">
            <!-- <button class="btn mt-4" type="submit" name="<?php echo 'view'.$count;?>" id="<?php echo 'view'.$count;?>" style="width:70%;border:2px solid #ffc104;margin:auto;display:block;border-radius:30px;color:white">View Details</button> -->
           <button class="btn mt-4" type="submit" name="<?php echo 'launch'.$count;?>" id="<?php echo 'launch'.$count;?>" style="width:70%;background: #ffc104;margin:auto;display:block;border-radius:30px">Launch</button>
        </div>
    </div>
  </div>
  <?php $count++;}?>
