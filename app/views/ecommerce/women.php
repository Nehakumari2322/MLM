...
<h1 class="mt-4 text-center">Women Fashion</h1>
			<div class="container-fluid" >
    			...
    			<div class="col-sm-3 my-3 ">
       			 <div class="card text-center h-100" style="padding:0px; border:2px solid white;box-shadow: 0px 4px 20px rgba(5,57,94,.5);">
           			 <div class="card-body">
                		<img src="<?php echo URLROOT.'/subcategory/'.$dataline->image;?>" class="image-fluid mx-auto d-block" height="250px" width="180px" alt="">
