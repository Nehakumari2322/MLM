...
<h1 class="mt-4 text-center">Electronics</h1>
			<div class="container-fluid" >
				<?php $count=0; foreach($data as $dataline){
         		if($count%4 == 0){ echo '<div class="row  mt-4 "  >';}?>
				<input type="hidden" value="<?php echo $dataline->subcategory_type_id;?>" name="<?php echo 'subcategory_type_id'.$count;?>">
    			<div class="col-sm-3 my-3 ">
       			 <div class="card " style="padding:0px; border:2px solid white;box-shadow: 0px 4px 20px rgba(5,57,94,.5);">
           			 <div class="card-body">
                		<img src="<?php echo URLROOT.'/subcategory/'.$dataline->image;?>" class="image-fluid" height="250px" width="280px" alt="">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 offset-sm-2 text-center colorlib-heading colorlib-heading-sm">
						<h2 class="mt-2 mb-4">Trusted Partners</h2>
					</div>
				</div>
				<div class="row">
