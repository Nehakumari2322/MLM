...
<form action="<?php echo URLROOT ;?>matrimunalendusers/takingtoregister" method="post" class="sign-in-form">
<div class="container ">
    <div class="row mt-5 mb-5">
        <div class="col-sm-8 mt-5 p-4 mb-5" style="margin:auto;display:block">
            <div class="card text-center p-4 mb-5" style="background:none">
                <h5 style="font-family: 'Pacifico', cursive;font-size:2rem;color:white"> You have not register Yourself for Matrimonial Sevice So please Register First Then You will be able  to View your profile </h5>
