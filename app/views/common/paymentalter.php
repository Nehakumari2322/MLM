...
<div class="container-fluid ">
    <div class="row">
        <div class="col " style="margin:auto;display:block">
            <div class="card text-center p-4 bg-primary " style="background:none">
                <h5 style="font-family: 'Pacifico', cursive;font-size:2rem;color:white">Your Transaction is under progress  please try after some time , wait for some time to Leverage our Service . </h5>
...
<div class="container">
        <div class="row mt-4 mb-4">
            ...
            <div class="col-sm-4">
                <!-- <form action="<?php echo URLROOT ;?>skillendusers/logmein" method="post" class="sign-in-form"> -->
            ...
            <div class="col-sm-4"> 
                <!-- <form action="<?php echo URLROOT ;?>ecommerceendusers/logmein" method="post" class="sign-in-form">   -->
                <div class="card pt-2 w3-hover-shadow" style="background:#F4D81F;border:none">
            ...
            <div class="col-sm-4">
            <!-- <form action="<?php echo URLROOT ;?>matrimunalendusers/logmein" method="post" class="sign-in-form"> -->
            <div class="card pt-2 w3-hover-shadow" style="background:#F4D81F;border:none">
